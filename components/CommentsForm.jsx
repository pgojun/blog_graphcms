...
const CommentsForm = ({ slug }) => {
    ...
    return (
        <div className='bg-white shadow-lg roundend-lg p-8 pb-12 mb-8'>
            <h3 className='text-xl mb-8 font-semibold corder-b pb-4'>Leave a reply</h3>
            ...
            <div className='mt-8'>
                ...
                >Comment sumbitted for review</span>}
            </div>
        </div>
    )
}
